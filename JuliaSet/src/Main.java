...
class ParallelJulliet extends Thread {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            switch (wybor) {
                case 1 -> ParallelJulliet.ustawStala(-0.123, 0.745);
                case 2 -> ParallelJulliet.ustawStala(-0.75, 0);
                case 3 -> ParallelJulliet.ustawStala(-0.390541, -0.586788);
                case 4 -> ParallelJulliet.ustawStala(0, 1);
                case 5 -> ParallelJulliet.ustawStala(0.355, 0.355);
                case 6 -> ParallelJulliet.ustawStala(0.34, -0.05);
                case 7 -> ParallelJulliet.ustawStala(-0.4, -0.59);
                default -> {
                }
            }
